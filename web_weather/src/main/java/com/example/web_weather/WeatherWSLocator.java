...
public class WeatherWSLocator extends org.apache.axis.client.Service implements com.example.web_weather.WeatherWS {
 ...
 */
    ...
    private java.lang.String WeatherWSSoap12_address = "http://ws.webxml.com.cn/WebServices/WeatherWS.asmx";
    ...
    public com.example.web_weather.WeatherWSSoap_PortType getWeatherWSSoap12() throws javax.xml.rpc.ServiceException {
    ...
    public com.example.web_weather.WeatherWSSoap_PortType getWeatherWSSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.example.web_weather.WeatherWSSoap12Stub _stub = new com.example.web_weather.WeatherWSSoap12Stub(portAddress, this);
    ...
    public com.example.web_weather.WeatherWSSoap_PortType getWeatherWSSoap() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public com.example.web_weather.WeatherWSSoap_PortType getWeatherWSSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.example.web_weather.WeatherWSSoap_BindingStub _stub = new com.example.web_weather.WeatherWSSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.example.web_weather.WeatherWSSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.example.web_weather.WeatherWSSoap12Stub _stub = new com.example.web_weather.WeatherWSSoap12Stub(new java.net.URL(WeatherWSSoap12_address), this);
                _stub.setPortName(getWeatherWSSoap12WSDDServiceName());
                return _stub;
            }
            if (com.example.web_weather.WeatherWSSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.example.web_weather.WeatherWSSoap_BindingStub _stub = new com.example.web_weather.WeatherWSSoap_BindingStub(new java.net.URL(WeatherWSSoap_address), this);
                _stub.setPortName(getWeatherWSSoapWSDDServiceName());
                return _stub;
            }
        }
